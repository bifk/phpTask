...
$MESS ['FORM_MESSAGE_QUESTION'] = "Сообщение";
$MESS ['FORM_AGREEMENT'] = "Нажимая «Отправить», Вы подтверждаете согласие на обработку персональных данных.";
$MESS ['FORM_SEND'] = "Отправить";
$MESS ['FORM_SENDED'] = "Отправлено";
$MESS ['FORM_SEND_ERROR'] = "Ошибка отправки";
?>
